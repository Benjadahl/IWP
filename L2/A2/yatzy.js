...
function calcTwoPairs(diceCount){
  let lDiceCount = JSON.parse(JSON.stringify(diceCount));
  let groupSize = 2;

  let p1 = calcIdentical(lDiceCount, groupSize);
  lDiceCount[p1/groupSize - 1] = 0;
  let p2 = calcIdentical(lDiceCount, groupSize); 
